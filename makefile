...
COMPONENT_FILES += mix_columns_byte.sv data_block_select.sv xor_init.sv round_key_adder.sv incriment_state.sv
COMPONENT_FILES	+= key_generator.sv g_function.sv ahb_fifo_io.sv MCU.sv
